...
public class AttachmentsComments extends BaseClass {
    ...
    @Test
    public void verify_document_link_validations_in_attachments_on_edit() {
    ...
    @Test
    public void verify_document_files_validations_in_attachments_on_edit() {
    ...
    @Test
    public void verify_comments_validations_in_attachments_on_edit() {
