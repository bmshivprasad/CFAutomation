...
public class SoilDescriptionAnalysisParameters extends BaseClass {
    ...
    public void verify_receiving_site_information_validations_in_soil_description() {
        ...
        if (verification.verifyReceivingSiteInfo()) {
            ...
            failure("ERROR : User can see the Receiving Site based on selected Site Quality.");
        }
        ...
        if (verification.verifyReceivingSiteUpdated()) {
            ...
            failure("ERROR : Receiving Site change based on the changes in the Site Quality.");
        }
